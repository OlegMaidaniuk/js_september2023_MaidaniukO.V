...
//
//
// const mahina = document.createElement('div');
// mahina.classList.add('mentos');
// mahina.style.backgroundColor = 'gray';
// mahina.style.color = 'purple';
// mahina.style.fontSize = '20px';
// mahina.innerText = 'a-ba-ba-ga-la-ma-ga';
// document.body.appendChild(mahina);
//
// const cloneMahina = mahina.cloneNode(true);
// cloneMahina.style.backgroundColor = 'black';
// document.body.appendChild(cloneMahina);
//
...
//     htmlliElement.style.backgroundColor = 'yellow';
...
// - створити блок,
// let div1 = document.body.createElement('div');
...
//
// element.innerText = 'ababagalamaga';
